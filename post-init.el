...
;; Just to make sure sometimes
(use-package show-eol :ensure t)
...
(use-package corfu
  ...
  :bind (:map corfu-map
              ...
              ("TAB" . corfu-next)      ;unsure whether this will have priority over meow
              ;([tab] . corfu-next)
              ("S-TAB" . corfu-prev)
              ;([backtab] . corfu-prev)
              ("RET" . corfu-insert))
...
(use-package kirigami
  :ensure t
  :config
  (global-set-key (kbd "C-c o TAB") 'kirigami-open-fold)     ; Open fold at point
  (global-set-key (kbd "C-c p TAB") 'kirigami-open-fold-rec) ; Open fold recursively
  (global-set-key (kbd "C-c O TAB") 'kirigami-open-folds)    ; Open all folds
  (global-set-key (kbd "C-c c TAB") 'kirigami-close-fold)    ; Close fold at point
  (global-set-key (kbd "C-c C TAB") 'kirigami-close-folds)   ; Close all folds
  (global-set-key (kbd "C-c TAB") 'kirigami-toggle-fold) ; Toggle fold at point
)
...
;; Language agnostic indentation control
...
;; Parenthesis balancing and indentation for lisps
